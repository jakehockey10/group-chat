$(document).on('turbolinks:load', function () {
  $('[type="file"]').fileupload({
    add: function (e, data) {
      data.progressBar = $('<div class="progress" style="width: 300px"><div class="progress-bar"></div></div>').insertBefore('#user_image');
      var options = {
      ...
      $.getJSON('/images/upload/cache/presign', options, function (result) {
        ...
        data.url = result['url'];
        // Amazon S3 needs this to say file instead
        // of the default in the case of uploading more
        // than just images.
        data.paramName = 'file';
        data.submit();
      });
